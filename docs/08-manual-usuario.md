...
- **Devolución** (botón en el ticket): solo dentro de **15 días** desde la venta; restituye el inventario por las cantidades indicadas por línea y marca la venta como **devuelta**. El motivo es opcional. En una venta de **contado con cliente** genera una **nota de crédito** por el total devuelto. No se puede devolver una venta a **crédito con abonos ya cobrados**.
